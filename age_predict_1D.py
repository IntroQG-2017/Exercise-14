...
###
### READ IN DATA FILE HERE - Don't forget to skip over the header line!
###
data = np.loadtxt()

# Fill in arrays using slices of data

# Loop over all lines and calculate your goodness-of-fit values here
...
###
### MODIFY PLOTTING TO USE SUBPLOTS
###

# THE UPPER PLOT SHOULD SHOW THE PREDICTED GEOTHERM AND PARTICLE TEMPERATURE-
# DEPTH HISTORY.

# THE LOWER PLOT SHOULD SHOW THE PREDICTED AND MEASURED THERMOCHRONOMETER AGES.
# I SUGGEST PLOTTING LATITUDE ON THE X-AXIS AND AGE ON THE Y-AXIS. PREDICTED
# THERMOCHRONOMETER AGES CAN BE SHOWN AS LINES OF CONSTANT AGE ACROSS THE
# FULL LATITUDE RANGE.
